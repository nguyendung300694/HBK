...
namespace HBK.Services
{
    public interface IProjectService
    {
        ...
        ProjectComment WriteNewComment(ProjectDetailsViewModel project);
    ...
    public class ProjectService : IProjectService
    {
        ...
        public ProjectComment WriteNewComment(ProjectDetailsViewModel project)
        {
            ...
            var ProjectComment = _db.ProjectComments.Find(comment.ProjectCommentID);
